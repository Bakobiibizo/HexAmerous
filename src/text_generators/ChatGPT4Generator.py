...
class GPT4Generator(Generator):
    ...
    def __init__(self):
        ...
        self.requires_env = ["OPENAI_API_KEY"] or ["AGENT_ARTIFICIAL_API_KEY"]
        self.streamable = True
        self.model_name = os.getenv("OPENAI_API_KEY")
    ...
    async def generate(
        ...
        try:
            ...
            openai.api_base = "https://text-celium.ngrok.app/v1"
...
available_generators.generators["GPT4Generator"] = get_GPT4Generator